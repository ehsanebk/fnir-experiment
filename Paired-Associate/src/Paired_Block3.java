...
public class Paired_Block3 extends JFrame implements KeyListener{
	JLabel num;
	JButton button;
	JTextField tf;
	JPanel buttonPanel;
	...
	String FILE_NAME = "./Paired_Block3_take1.txt";
	...
	public static void main(String args[]) {
		Paired_Block3 environment = new Paired_Block3();
