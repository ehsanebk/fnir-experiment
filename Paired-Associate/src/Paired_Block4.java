...
public class Paired_Block4 extends JFrame implements KeyListener{
	JLabel num;
	JButton button;
	JTextField tf;
	JPanel buttonPanel;
	...
	String FILE_NAME = "./Paired_Block4_take1.txt";
	...
	public static void main(String args[]) {
		Paired_Block4 environment = new Paired_Block4();
