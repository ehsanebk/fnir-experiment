...
figure
hold on
average_matrix1 = zeros(1, average_interval+1);
average_matrix2 = zeros(1, average_interval+1);

data_lp1=lpf(data(:,11),filttype,fs,fcut,filtlen);
data_lp2=lpf(data(:,13),filttype,fs,fcut,filtlen);

average_matrix1(1,:)      = data_lp1(2462: 2462+average_interval );% 2324 Trial 9
average_matrix1(end +1,:) = data_lp1(2746: 2746+average_interval );% 2602 Trial 10
average_matrix1(end +1,:) = data_lp1(3030: 3030+average_interval );% 2886 Trial 12 
average_matrix1(end +1,:) = data_lp1(3315: 3315+average_interval );% 3170 Trial 13
average_matrix1(end +1,:) = data_lp1(3595: 3595+average_interval );% 3455 Trial 14 
average_matrix1(end +1,:) = data_lp1(3892: 3892+average_interval );% 3735 Trial 15
average_matrix1(end +1,:) = data_lp1(4165: 4165+average_interval );% 4032 Trial 16 
average_matrix1(end +1,:) = data_lp1(4443: 4443+average_interval );% 4306 Trial 17
average_matrix1(end +1,:) = data_lp1(4725: 4725+average_interval );% 4584 Trial 18 
average_matrix1(end +1,:) = data_lp1(4999: 4999+average_interval );% 4865 Trial 19
average_matrix1(end +1,:) = data_lp1(5281: 5281+average_interval );% 5139 Trial 20 
average_matrix1(end +1,:) = data_lp1(5554: 5554+average_interval );% 5421 Trial 21
average_matrix1(end +1,:) = data_lp1(5844: 5844+average_interval );% 5694 Trial 22 
average_matrix1(end +1,:) = data_lp1(6127: 6127+average_interval );% 5985 Trial 23
average_matrix1(end +1,:) = data_lp1(6414: 6414+average_interval );% 6267 Trial 24 
average_matrix1(end +1,:) = data_lp1(6686: 6686+average_interval );% 6555 Trial 25
average_matrix1(end +1,:) = data_lp1(6969: 6969+average_interval );% 6826 Trial 26 
average_matrix1(end +1,:) = data_lp1(7239: 7239+average_interval );% 7109 Trial 27
average_matrix1(end +1,:) = data_lp1(7522: 7522+average_interval );% 7379 Trial 28
average_matrix1(end +1,:) = data_lp1(7796: 7796+average_interval );% 7662 Trial 29
average_matrix1(end +1,:) = data_lp1(8070: 8070+average_interval );% 7936 Trial 30 


average_matrix2(1,:)      = data_lp2(2462: 2462+average_interval ); % 2324 Trial 9
average_matrix2(end +1,:) = data_lp2(2746: 2746+average_interval );% 2602 2602 Trial 10
average_matrix2(end +1,:) = data_lp2(3030: 3030+average_interval );% 2886 2886 Trial 12 
average_matrix2(end +1,:) = data_lp2(3315: 3315+average_interval );% 3170 3170 Trial 13
average_matrix2(end +1,:) = data_lp2(3595: 3595+average_interval );% 3455 3455 Trial 14 
average_matrix2(end +1,:) = data_lp2(3892: 3892+average_interval );% 3735 3735 Trial 15
average_matrix2(end +1,:) = data_lp2(4165: 4165+average_interval );% 4032 4032 Trial 16 
average_matrix2(end +1,:) = data_lp2(4443: 4443+average_interval );% 4306 4306 Trial 17
average_matrix2(end +1,:) = data_lp2(4725: 4725+average_interval );% 4584 4584 Trial 18 
average_matrix2(end +1,:) = data_lp2(4999: 4999+average_interval );% 4865 4865 Trial 19
average_matrix2(end +1,:) = data_lp2(5281: 5281+average_interval );% 5139 5139 Trial 20 
average_matrix2(end +1,:) = data_lp2(5554: 5554+average_interval );% 5421 5421 Trial 21
average_matrix2(end +1,:) = data_lp2(5844: 5844+average_interval );% 5694 5694 Trial 22 
average_matrix2(end +1,:) = data_lp2(6127: 6127+average_interval );% 5985 5985 Trial 23
average_matrix2(end +1,:) = data_lp2(6414: 6414+average_interval );% 6267 6267 Trial 24 
average_matrix2(end +1,:) = data_lp2(6686: 6686+average_interval );% 6555 6555 Trial 25
average_matrix2(end +1,:) = data_lp2(6969: 6969+average_interval );% 6826 6826 Trial 26 
average_matrix2(end +1,:) = data_lp2(7239: 7239+average_interval );% 7109 7109 Trial 27
average_matrix2(end +1,:) = data_lp2(7522: 7522+average_interval );% 7379 7379 Trial 28 
average_matrix2(end +1,:) = data_lp2(7796: 7796+average_interval );% 7662 7662 Trial 29 
average_matrix2(end +1,:) = data_lp2(8070: 8070+average_interval );% 7936 7936 Trial 30

plot(mean(average_matrix1,1));
plot(mean(average_matrix2,1));
title('block1-2 deoxy 11 13 Average');
...
data_lp1=lpf(data(:,10),filttype,fs,fcut,filtlen);
data_lp2=lpf(data(:,17),filttype,fs,fcut,filtlen);
...
plot(mean(average_matrix1,1));
plot(mean(average_matrix2,1));
title('block1-2 deoxy 10 17 Average');
...
data_lp1=lpf(data(:,9),filttype,fs,fcut,filtlen);
data_lp2=lpf(data(:,16),filttype,fs,fcut,filtlen);
...
plot(mean(average_matrix1,1));
plot(mean(average_matrix2,1));
title('block1-2 deoxy 9 16 Average');
legend('Channel 9','Channel 16');
line([20 20] , [-0.3 0.1] , 'Color','r');
line([80 80] , [-0.3 0.1] , 'Color','r');
line([140 140] , [-0.3 0.1] , 'Color','r');
